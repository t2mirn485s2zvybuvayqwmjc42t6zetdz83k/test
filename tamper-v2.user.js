...
// @author       dogix#9999
// @match        https://smile.amazon.com/dp/*/?m=A2L77EE7U53NWQ
// @match        https://smile.amazon.com/gp/product/ajax/ref=auto_load_aod?asin=*&pc=*&experienceId=aodAjaxMain&autodetect=1
...
(function() {
    ...
    function AODCheck()
    {
        ...
        if (html.includes("10158976011"))
        {
            ...
            var searchoffers = (fetch("https://smile.amazon.com/gp/product/ajax/?asin="+asin+"&m=A2L77EE7U53NWQ&experienceId=aodAjaxMain", {
                "credentials": "include",
                "headers": {
